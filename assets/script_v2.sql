...
CREATE TABLE Aplicacao (
    id integer NOT NULL CONSTRAINT Aplicacao_pk PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE Aplicante (
    id integer NOT NULL CONSTRAINT Aplicante_pk PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE Categoria_Prioritaria (
    id integer NOT NULL CONSTRAINT Grupo_pk PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE Estabelecimento (
    id integer NOT NULL CONSTRAINT Estabelecimento_pk PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE Localidade (
    id integer NOT NULL CONSTRAINT Localidade_pk PRIMARY KEY AUTOINCREMENT,
...
-- Table: Lote
CREATE TABLE Lote (
    id integer NOT NULL CONSTRAINT Vacina_pk PRIMARY KEY AUTOINCREMENT,
